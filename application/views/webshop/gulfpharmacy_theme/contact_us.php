...
<head>
    ...
    <title>Contact Us - Gulf Pharmacy</title>
    <meta name="description" content="Get in touch with Gulf Pharmacy">
    ...
    <link rel="stylesheet" href="<?= $assets ?>gulfpharmacy_theme/css/contact_us.css">
...
<body class="" style="top: 101px;">
    ...
    <script src="<?= $assets ?>gulfpharmacy_theme/js/contact_us.js"></script>
    <script>
        jQuery(function() {
            jQuery.scrollDepth();
        });
