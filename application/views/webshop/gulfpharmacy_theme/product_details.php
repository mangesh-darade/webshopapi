...
<body>
    ...
    $noImage = webshop_media_src($uploads, 'no_image.png');
    $productImage = !empty($product['image']) ? webshop_media_src($uploads, $product['image']) : $noImage;
                    ...
                    <div class="images">
                        <div class="slider-product-contain">
                            <div class="slider slider-product">
                                ...
                                ?>
                                        <div><a href="<?= $productImage ?>"><img src="<?= webshop_media_src($uploads, $image['photo']) ?>" class="img-responsive" title="<?= $productName ?>" alt="<?= $productName ?>" itemprop="image" /></a></div>
                                    <?php
                                    }
                                } else {  ?>
