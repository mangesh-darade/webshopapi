        ...
        <div class="row">
            <div class="col-md-4 logo-search">
                ...
                <a href="<?= base_url('webshop') ?>">
                    <img src="<?= webshop_media_src($uploads, $logo_image) ?>" alt="Logo" style=" margin-top: -25px; height: 130px; width: 160px;">
                </a>
            </div><!--/col-->
            ...
            <div class="row f-links">
                    ...
                    <ul>
                        ...
                        <?php if (!empty($footer_theme_pages) && is_array($footer_theme_pages)): ?>
                            <?php foreach ($footer_theme_pages as $themePage): ?>
                                <li><a class="underline" href="<?= baseurl('webshop/' . $themePage['slug']) ?>"><?= htmlspecialchars($themePage['title']) ?></a></li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 column categories">
                    ...
                    <ul>
                        ...
                        $customPagesObj = isset($this->data['custom_pages']) && is_object($this->data['custom_pages']) ? $this->data['custom_pages'] : (object) [];
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 column">
                    <h5>Your Account</h5>
                    <ul>
                        <?php $webshopSession = (isset($this->session->webshop) && is_object($this->session->webshop)) ? $this->session->webshop : (object) ['is_login' => "false"]; ?>
                        <li><a class="underline" href="<?= ($webshopSession->is_login == "true") ? base_url('webshop/your_account') : base_url('webshop/login') ?>">Manage Account</a></li>
