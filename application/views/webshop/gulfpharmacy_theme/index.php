...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= webshop_media_src($uploads, 'webshop/herbinn_favicon.ico') ?>">
    <style>
        .category-contain {
            display: grid;
...
<body>
    ...
    <div class="container splash">
        ...
        <div class="container splash">
            ...
            <img src="<?= webshop_media_src($uploads, $banner_image) ?>" alt="Celebrate! 10% Off Sitewide" class="img-responsive img-ctr" style="height: 300px; width: 113rem; max-width: 100%;
            ...
            <!-- <div>
                <a
                    ...
                    ?>
                    <img src="<?= webshop_media_src($uploads, $banner_image) ?>" alt="Celebrate! 10% Off Sitewide" class="img-responsive img-ctr lazyload" data-srcset="<?= webshop_media_src($uploads, $banner_image) ?>" style="height: 300px; width: 113rem; max-width: 100%;
    ...
    <?php
    $homePageSectionsArr = isset($this->data['custom_pages']['header_strip']) && is_array($this->data['custom_pages']['header_strip']) ? $this->data['custom_pages']['header_strip'] : [];
    ...
    <div class="container">
        ...
        <p>
            ...
            if (!empty($homePageWelcomeMessageSection))
                ...
                ?>
                        <div>
                            <a
                                ...
                                class="item-alt">
                                <img class="cat-image"
                                    src="<?= !empty($category->image) ? webshop_media_src($uploads, $category->image) : $thumbs . 'no_image.png' ?>"
                                    alt="Trending" />
                                <h5><?= $category->name; ?></h5>
                            </a>
                        </div>
    ...
    if (!empty($homePageCompanyUpdatesSection) && !empty($homePageCompanyUpdatesSection['page_text'])) { ?>
        <div class="section nwupdate">
            <div class="container">
                <?php echo $homePageCompanyUpdatesSection['page_text']; ?>
            </div>
        </div>
    <?php } ?>
        ...
        <script>
            if (document.getElementById('pdf-canvas'))
                var certificateUrl = <?= json_encode(webshop_media_src($uploads, 'webshop/pages/' . $homePageCompanyCertificationSection['page_file'])) ?>;
        </script>
</body>
