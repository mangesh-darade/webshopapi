...
<head>
    ...
    <title>Cart - Gulf Pharmacy</title>
    ...
    <link href="<?= $assets ?>gulfpharmacy_theme/css/checkout.css" rel="stylesheet" type="text/css" charset="utf-8">
...
<body class="scrolly" style="top: 100px;">
                ...
                <div class="main-content shop-cart full-width">
                    ...
                    <?php if (is_array($cart_items) && count($cart_items)) { ?>
                        ...
                        foreach ($cart_items as $itemKey => $item) {
                            $cart_products = (isset($cart_data['products']) && is_array($cart_data['products'])) ? $cart_data['products'] : array();
                            $pinfo = isset($cart_products[$item['product_id']]) ? $cart_products[$item['product_id']] : null;
                            if (isset($cart_data['variant_images']) && is_array($cart_data['variant_images']) && !empty($cart_data['variant_images'][$itemKey])) {
                                $item_image = $cart_data['variant_images'][$itemKey];
                            } else {
                                $item_image = ($pinfo && !empty($pinfo['image'])) ? $pinfo['image'] : 'no_image.png';
                            }

                            $item_name = ($pinfo && isset($pinfo['name'])) ? $pinfo['name'] : ('Product #' . (int) $item['product_id']);
                        ...
                        ?>
                            <form method="post" name="basketform" id="modify-basket">
                                <div class="product">
                                    <div class="item info">
                                        <a href="<?= base_url("webshop/product_details/" . md5($item['product_id'])) ?>"><img src="<?= webshop_media_src($uploads, $item_image) ?>"
                        ...
                        <div class="cart-checkout">
                            ...
                            <div class="seals">
                                <!-- <img src="<?= $assets ?>gulfpharmacy_theme/images/secure-credit-card-payment.jpg"
                            ...
                            <div class="paymentOptions" style="text-align:right; clear:both;">
                                <!-- <p
                                    ...
                                    <img
                                        src="<?= $assets ?>gulfpharmacy_theme/images/pp_cc_mark_37x23.jpg"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="guarantee-notice-new">
                                        <a href="#"><img
                                                src="<?= $assets ?>gulfpharmacy_theme/images/headline-guarantee.png"></a>
    ...
    <script>
        ...
        const currencySymbol = "<?= isset($Settings->symbol) ? htmlspecialchars((string) $Settings->symbol, ENT_QUOTES, 'UTF-8') : '$' ?>";
    </script>
    ...
    <script src="<?= $assets ?>gulfpharmacy_theme/js/cart.js"></script>
</body>
