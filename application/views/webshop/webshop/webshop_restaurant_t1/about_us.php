...
<head>
    ...
    <title>About Meenatshi Chettinadu Restaurant – Al Quoz, Dubai</title>
    <meta name="author" content="Vecuro">
    <meta name="description" content="Meenatshi Chettinadu Restaurant in Al Quoz, Dubai serves traditional South Indian dishes made with love. Discover our culinary roots and story today.">
            ...
            <div class="row flex-row-reverse py-20">                
                <div class="col-lg-12">
                    <div class="about-content py-50 px-50" style="width: 100%;">
                        ...
                        <p class="about-text mb-xl-55"><?= isset($about_us->page_text) ? $about_us->page_text : '' ?></p>
...
============================== -->
    ...
    <script>
        ...
        document.querySelector("title").textContent = `About Us - ${title}`;
    </script>
</body>
