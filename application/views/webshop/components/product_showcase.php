...
<section class="gp-section" aria-labelledby="product-showcase-heading">
    <div class="container">
        ...
        <?php if ($showCarousel): ?>
            <?= $this->load->view('webshop/components/product_carousel', array('items' => $items, 'uploads' => $uploadsBase, 'thumbs' => $thumbsBase), true) ?>
        <?php endif; ?>

        <?php if ($showGrid): ?>
            <?= $this->load->view('webshop/components/product_grid', array('items' => $items, 'uploads' => $uploadsBase, 'thumbs' => $thumbsBase), true) ?>
        <?php endif; ?>
    </div>
</section>
