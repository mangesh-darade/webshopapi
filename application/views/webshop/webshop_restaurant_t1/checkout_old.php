    ...
    <div class="vs-checkout-area pt-20 pb-lg-120 pb-30">
        <div class="container">
            <!-- <div class="row justify-content-center text-center">
                <div class="col-xl-4">
                    <form action="#" class="vs-cart-coupon pb-5 form-group">
                        <label for="coupon-field">Have a coupon code?</label>
                        <input class="form-control mb-4" type="text" id="coupon-field" placeholder="Enter coupon code"
                            required="required">
                                    ...
                                    <div id="pickupMessage" style="display: none; margin-top: 10px;">
                                        ...
                                        <div class="col-12" id="pickup-area" style="padding-top: 5px; margin-left: -30px;">
                                            <div class="col-12" id="delivery-area"
                                                ...
                                                <div class="col-12 input-group-prepend pl-0 pb-4">
                                                    <span class="pt-2 mr-2">Select Area : </span>
                                                    <select class="form-control areadropdown ml-2" id="areachargess"
                                                        name="areacharges">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="billing_first_name"
                                            ...
                                            value="<?= isset($postdata['billing_first_name']) ? $postdata['billing_first_name'] : '' ?>"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="billing_last_name"
                                            ...
                                            value="<?= isset($postdata['billing_last_name']) ? $postdata['billing_last_name'] : '' ?>"
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="email" class="form-control" id="billing_email" name="billing_email"
                                            value="<?= isset($postdata['billing_email']) ? $postdata['billing_email'] : '' ?>"
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="input-group">
                                                ...
                                                <select class="country_code" id="country_code" name="country_code"
                                                    ...
                                                    if (is_array($country)) {
                                                        foreach ($country as $countrycode) {
                                                            ...
                                                            echo '<option value="' . $value . '" ' . $selected . '>' . $countrycode->code . '</option>';
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <input type="tel" class="form-control custome-margin" id="billing_phone"
                                                style="margin-left: -32px;" name="billing_phone"
                                                value="<?= isset($postdata['billing_phone']) ? $postdata['billing_phone'] : '' ?>"
    ...
    $(document).ready(function() {
        ...
        $('#areachargess').on('change', function() {
            ...
            if (baseTotal < minimumOrder) {
                ...
                //     .prop('disabled', true)
                //     .addClass('disabled');
                var totalWithShipping = baseTotal + extraCharges;
