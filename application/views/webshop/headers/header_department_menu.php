<div id="departments-menu" class="departments-menu dropdown">
    <button class="btn dropdown-toggle btn-block" type="button" data-toggle="dropdown" data-bs-toggle="dropdown" 
        aria-expanded="false" data-bs-target="#collapseList" id="random">
    ...
    <ul id="menu-departments-menu" class="dropdown-menu yamm departments-menu-dropdown collapse" id="collapseList">
        ...
        <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu dropdown-item">
            <a title="<?= $category->name ?>" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true"
                href="<?= base_url("webshop/category_products/".$category->id)?>"><?= $category->name ?> <span
                    class="caret"></span></a>
                        ...
                        <div class="bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                            <div class="kc-col-container">
                                <div class="kc_single_image">
                                    <img src="<?= $uploads . $category->image ?>" class="img"
                                        alt="<?= $category->name ?>" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="kc-col-container">
                                    <div class="kc_text_block">
                                        <ul>
                                            ...
                                            <li>
                                                <a
                                                    href="<?= base_url("webshop/products/?q=cetegory&catid=".$category->id."&key=".str_replace([' & ', '&',' ','-'], '_', $category->name)."&id=".md5($category->id))?>">
                                    ...
                                    <div class="kc_text_block">
                                        <ul>
                                            ...
                                            <li style="display: inline-table; width: 49%;"><a
                                                    href="<?= base_url("webshop/products/?q=brand&catid=".$category->id."&key=".str_replace([' & ', '&',' ','-'], '_', $brands->brand_name)."&id=".md5($brands->brand_id))?>"><?= $brands->brand_name ?></a>
                                            </li>
                                            <?php
                                                            }
                                                        }
        ...
        <?php } else { ?>
        <li class="menu-item menu-item-type-custom animate-dropdown dropdown-item">
            <a title="<?= $category->name ?>"
                href="<?= base_url("webshop/category_products/".$category->id)?>"><?= $category->name ?></a>
        </li>
        <?php } ?>
        <?php
            }//end foreach.
