...
<?php if (empty($gp_swasthe_styles_in_head) && function_exists('webshop_theme_has_stylesheet') && webshop_theme_has_stylesheet('css/cms-swasthe-fonts.css')) : ?>
<link rel="stylesheet" href="<?= htmlspecialchars(webshop_theme_assets_url('css/cms-swasthe-fonts.css?ver=20260603a'), ENT_QUOTES, 'UTF-8') ?>">
<?php endif; ?>
<?php if (empty($gp_swasthe_styles_in_head) && function_exists('webshop_theme_has_stylesheet') && webshop_theme_has_stylesheet('css/cms-swasthe-global.css')) : ?>
<link rel="stylesheet" href="<?= htmlspecialchars(webshop_theme_assets_url('css/cms-swasthe-global.css?ver=20260603b'), ENT_QUOTES, 'UTF-8') ?>">
<?php endif; ?>
<?php if (empty($gp_swasthe_styles_in_head) && function_exists('webshop_theme_has_stylesheet') && webshop_theme_has_stylesheet('css/cms-swasthe-global.css')) : ?>
<script>
tailwind.config = {
  corePlugins: { preflight: false },
  safelist: ['py-12', 'py-10', 'px-6', 'md:py-20'],
  theme: {
    extend: {
      colors: {
        'swasthe-navy': '#0a1d37',
        'swasthe-orange': '#b9860b',
