...
<head>
    ...
    <?php if (function_exists('webshop_theme_has_stylesheet') && webshop_theme_has_stylesheet('css/cms-swasthe-fonts.css')) : ?>
    <link rel="stylesheet" href="<?= webshop_theme_assets_url('css/cms-swasthe-fonts.css?ver=20260603a') ?>">
    <?php endif; ?>
    <?php if (function_exists('webshop_theme_has_stylesheet') && webshop_theme_has_stylesheet('css/cms-swasthe-global.css')) : ?>
    <link rel="stylesheet" href="<?= webshop_theme_assets_url('css/cms-swasthe-global.css?ver=20260603b') ?>">
    <script>
    tailwind.config = {
    ...
    <?php $gp_swasthe_styles_in_head = true; ?>
