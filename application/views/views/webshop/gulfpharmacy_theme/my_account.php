...
<head>
    ...
    <title>About Us - Gulf Pharmacy</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato:400,400italic,700,700italic|Oxygen:700" rel="stylesheet"
        type="text/css">
    <link href="<?= $assets ?>gulfpharmacy_theme/css/main.css?ver=210616_01" rel="stylesheet" media="screen"
        charset="utf-8">
    <link href="<?= $assets ?>gulfpharmacy_theme/css/print.css" rel="stylesheet" type="text/css" media="print"
        charset="utf-8">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?= $assets ?>gulfpharmacy_theme/css/jquery-ui.min.css" rel="stylesheet" type="text/css" charset="utf-8">
    <link href="<?= $assets ?>gulfpharmacy_theme/css/new-template.css?ver=230912_06" rel="stylesheet" type="text/css"
        media="screen" charset="utf-8">
    <link rel="stylesheet" href="<?= $assets ?>gulfpharmacy_theme/css/about-us.css">
    ...
    <link rel="stylesheet" href="<?= $assets ?>gulfpharmacy_theme/css/my_account.css">
    <link rel="stylesheet" href="<?= $assets ?>gulfpharmacy_theme/css/tracking_order.css">
    <!-- my_account.css -->
...
<body>
    ...
    <script defer type="text/javascript" src="<?= $assets ?>gulfpharmacy_theme/js/my_orders.js"></script>
    <script>
