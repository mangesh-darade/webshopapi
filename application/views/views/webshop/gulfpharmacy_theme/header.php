    ...
    <div class="header-inner">
        ...
        <nav>
                ...
                <div class="dropdown nav-pd-ddm">
                    ...
                    <ul class="dropdown-menu nav-categories">
                        ...
                        foreach ($categories as $category) { ?>
                            <li><a class="dropdown-item <?= ($category->id == $activeCategoryId) ? 'highlight-nav-option' : '' ?>" 
            ...
            <?php if (!empty($has_active_blogs)): ?>
                <a id="blogs-nav" href="<?= base_url('blogs') ?>" class="nav-opt">Blogs</a>
            <?php endif; ?>
            ...
            <?php if (!empty($header_theme_pages) && is_array($header_theme_pages)): ?>
                <?php foreach ($header_theme_pages as $themePage): ?>
                    <a href="<?= base_url('webshop/' . $themePage['slug']) ?>" class="nav-opt"><?= htmlspecialchars($themePage['title']) ?></a>
                <?php endforeach; ?>
            <?php endif; ?>
            <!-- <?php
        ...
        <?php
        if ($isLoggedIn) { ?>
            <a href="<?= base_url('webshop/your_account') ?>" class="show-user"><img src="<?= $assets . 'restaurant/img/my_profile_icon.svg' ?>" /><?= explode(" ", $webshopSession->name)[0] ?></a>
        <?php }
        ?>
