...
<head>
    ...
    <title>New Customer Registration - Gulf Pharmacy</title>
...
<body class="" style="top: 100px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <button type="button" id="togglePasswordRegister" class="passToggler"
                                    ...
                                    <img src="<?= $assets ?>gulfpharmacy_theme/images/eye-hide.png" alt="Hide" width="20" height="20">
                                </button>
                            </div>
    ...
    <script src="<?= $assets ?>gulfpharmacy_theme/js/register.js" defer></script>
    <script type="module" src="<?= $assets ?>gulfpharmacy_theme/js/common.js" defer></script>
    <script>
        const assets = "<?= $assets ?>";
    </script>
</body>
