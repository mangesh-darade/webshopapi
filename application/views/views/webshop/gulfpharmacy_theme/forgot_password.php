...
<head>
    ...
    <title>Forgot Password - Gulf Pharmacy</title>
...
<body>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5" style="display:flex">
                                ...
                                <button type="button" id="toggleNewPassword" class="passToggler"
                                    ...
                                    <img src="<?= $assets ?>gulfpharmacy_theme/images/eye-show.png" alt="Hide" width="20" height="20">
                                </button>
                            </div>
                        </div>
    ...
    <!-- <script src="<?= $assets ?>gulfpharmacy_theme/js/common.js" defer></script> -->
    <script type="module" src="<?= $assets ?>gulfpharmacy_theme/js/forgot_password.js" defer></script>
    <script>
        const assets = "<?= $assets ?>";
    </script>
